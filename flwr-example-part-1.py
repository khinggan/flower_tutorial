...
# set traininig and testing function
...
# get the updated model parameters from the local model. client -> server
def get_parameters(net) -> List[np.ndarray]:
    return [val.cpu().numpy() for _, val in net.state_dict().items()]

# update the local model with parameters received from the server. server -> client
